    ...
    <div className="min-h-screen bg-matte text-offwhite selection:bg-accent selection:text-matte overflow-x-hidden">
      ...
      <header className="relative pt-56 pb-32 px-6">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full pointer-events-none -z-10">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-contributor/20 rounded-full blur-[120px] animate-pulse"></div>
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-learner/10 rounded-full blur-[120px] animate-pulse delay-1000"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-10 bg-gunmetal border border-white/5 rounded-[40px] hover:border-accent/20 transition-all group cursor-pointer text-left">
              <div className="w-14 h-14 bg-contributor/10 text-contributor rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
            ...
            <div className="p-10 bg-gunmetal border border-white/5 rounded-[40px] hover:border-accent/20 transition-all group cursor-pointer text-left">
              <div className="w-14 h-14 bg-learner/10 text-learner rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform">
      ...
      <section id="categories" className="py-32 px-6 bg-gunmetal/30">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          <div className="text-left">
            ...
            <div className="space-y-6">
              <div className="p-8 rounded-[32px] bg-white/5 border border-white/10 flex gap-6 hover:bg-white/10 transition-colors">
                <div className="w-12 h-12 bg-contributor text-white rounded-xl flex items-center justify-center shrink-0">
              ...
              <div className="p-8 rounded-[32px] bg-white/5 border border-white/10 flex gap-6 hover:bg-white/10 transition-colors">
                <div className="w-12 h-12 bg-learner text-white rounded-xl flex items-center justify-center shrink-0">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-10 -left-10 w-32 h-32 bg-learner/20 rounded-full blur-2xl"></div>
          </div>
        </div>
      </section>
      ...
      <footer className="py-20 border-t border-white/5 bg-matte">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-10">
          ...
          >
            <span className="font-black tracking-tighter text-lg"><img src={logo} alt="LOGO" className="w-32 h-auto block" /></span>
          </div>
