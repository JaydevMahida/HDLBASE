 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function on(t){return t&&t._delegate?t._delegate:t}class D{constructor(e,n,r){this.name=e,this.instanceFactory=n,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tt{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(nt(n)){const r=n.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(n=>n).join(" ")}}function nt(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const L="@firebase/app",q="0.14.6";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const u=new je("@firebase/app"),rt="@firebase/app-compat",st="@firebase/analytics-compat",it="@firebase/analytics",ot="@firebase/app-check-compat",at="@firebase/app-check",ct="@firebase/auth",ht="@firebase/auth-compat",lt="@firebase/database",dt="@firebase/data-connect",ft="@firebase/database-compat",ut="@firebase/functions",pt="@firebase/functions-compat",mt="@firebase/installations",gt="@firebase/installations-compat",bt="@firebase/messaging",yt="@firebase/messaging-compat",Et="@firebase/performance",_t="@firebase/performance-compat",Ct="@firebase/remote-config",wt="@firebase/remote-config-compat",vt="@firebase/storage",It="@firebase/storage-compat",Dt="@firebase/firestore",St="@firebase/ai",At="@firebase/firestore-compat",Bt="firebase",Ot="12.6.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hn=Ot;function Rt(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r={name:k,automaticDataCollectionEnabled:!0,...e},s=r.name;if(typeof s!="string"||!s)throw g.create("bad-app-name",{appName:String(s)});if(n||(n=ie()),!n)throw g.create("no-options");const i=S.get(s);if(i){if($(n,i.options)&&$(r,i.config))return i;throw g.create("duplicate-app",{appName:s})}const o=new Le(s);for(const c of F.values())o.addComponent(c);const l=new xt(n,r,o);return S.set(s,l),l}function ln(t=k){const e=S.get(t);if(!e&&t===k&&ie())return Rt();if(!e)throw g.create("no-app",{appName:t});return e}function x(t,e,n){let r=Tt[t]??t;n&&(r+=`-${n}`);const s=r.match(/\s|\//),i=e.match(/\s|\//);if(s||i){const o=[`Unable to register library "${r}" with version "${e}":`];s&&o.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&i&&o.push("and"),i&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),u.warn(o.join(" "));return}U(new D(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zt(t){U(new D("platform-logger",e=>new tt(e),"PRIVATE")),U(new D("heartbeat",e=>new Ft(e),"PRIVATE")),x(L,q,t),x(L,q,"esm2020"),x("fire-js","")}zt("");export{D as C,ae as E,C as F,je as L,hn as S,cn as _,an as a,Gt as b,we as c,on as d,$ as e,Ie as f,ln as g,oe as h,Rt as i,Yt as j,Qt as k,en as l,nn as m,qt as n,h as o,Jt as p,rn as q,x as r,be as s,Xt as t,Kt as u,U as v,sn as w,Wt as x,Zt as y,tn as z};
